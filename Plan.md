...
1. **Номер карты со статусом APPROVED.**
   ...
   **Ожидаемый результат:**
   ...
   - В базе данных будет создана запись об успешном платеже с указанием способа оплаты.
...
2. **Номер карты со статусом DECLINED.**
   ...
   **Ожидаемый результат:**
   ...
   - В базе данных будет создана запись о неуспешном платеже с указанием способа оплаты.
...
1. **Пустая форма**
   ...
   **Ожидаемый результат:**
   ...
   - В базе данных не будет создана запись о платеже.
